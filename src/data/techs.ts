...
// Le logo OpenAI n'est plus dans simple-icons : tracé repris de simple-icons@10.4.0 (logo monochrome)
const chatGpt: Tech = {
  name: 'ChatGPT',
  hex: '0D0D0D',
 ...
 * Rangée 1 : web, back-end & IA — Rangée 2 : mobile, bases de données et outils.
